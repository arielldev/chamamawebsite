...
export function Footer() {
  return (
    <footer className="relative z-10 bg-page-sync">
      <div className="mx-auto max-w-7xl px-6 md:px-10 py-10 md:py-12 space-y-8">
          ...
          <div className="space-y-4 max-w-3xl">
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              <a
                ...
                aria-label="YouTube"
                title="YouTube"
                className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white ring-1 ring-(--accent-sage)/30 hover:text-(--accent-sage) hover:ring-(--accent-sage)/60 transition"
              >
                <FaYoutube size={18} />
              </a>
              <a
        ...
        <div className="h-px w-full bg-linear-to-l from-transparent via-(--accent-sage)/30 to-transparent" />
